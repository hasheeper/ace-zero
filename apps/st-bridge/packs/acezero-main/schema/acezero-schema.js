...
const ASSET_DECK_CARD_SLOT_TAGS = {
  ...
  asset_skill_grand_wish_l1: ['general'],
  asset_skill_grand_wish_l2: ['general'],
  asset_skill_grand_wish_l3: ['general'],
  asset_skill_grand_wish_l4: ['general'],
  asset_skill_divine_order_l1: ['general'],
  asset_skill_divine_order_l2: ['general'],
  asset_skill_divine_order_l3: ['general'],
  asset_skill_divine_order_l4: ['general'],
  asset_skill_hex_l1: ['general'],
  asset_skill_hex_l2: ['general'],
  asset_skill_hex_l3: ['general'],
  asset_skill_hex_l4: ['general'],
  asset_skill_havoc_l1: ['general'],
  asset_skill_havoc_l2: ['general'],
  asset_skill_havoc_l3: ['general'],
  asset_skill_havoc_l4: ['general'],
  asset_skill_catastrophe_l1: ['general'],
  asset_skill_catastrophe_l2: ['general'],
  asset_skill_catastrophe_l3: ['general'],
  asset_skill_catastrophe_l4: ['general'],
  asset_skill_analysis_l1: ['general'],
  asset_skill_analysis_l2: ['general'],
  asset_skill_analysis_l3: ['general'],
  asset_skill_analysis_l4: ['general'],
  asset_skill_premonition_l1: ['general'],
  asset_skill_premonition_l2: ['general'],
  asset_skill_premonition_l3: ['general'],
  asset_skill_premonition_l4: ['general'],
  asset_skill_refraction_l1: ['general'],
  asset_skill_refraction_l2: ['general'],
  asset_skill_refraction_l3: ['general'],
  asset_skill_refraction_l4: ['general'],
  asset_skill_insulation_l1: ['general', 'void'],
  asset_skill_insulation_l2: ['general', 'void'],
  asset_skill_insulation_l3: ['general', 'void'],
  asset_skill_insulation_l4: ['general', 'void'],
  asset_skill_reality_l3: ['general', 'void'],
  asset_skill_reality_l4: ['general', 'void'],
  asset_mana_max_bronze: ['general'],
  asset_mana_max_silver: ['general'],
  asset_mana_max_gold: ['general'],
  asset_mana_amp_bronze: ['general'],
  asset_mana_amp_silver: ['general'],
  asset_mana_amp_gold: ['general'],
  asset_mana_reduce_bronze: ['general'],
  asset_mana_reduce_silver: ['general'],
  asset_mana_reduce_gold: ['general'],
  asset_skill_upgrade_bronze: ['general'],
  asset_skill_upgrade_silver: ['general'],
  asset_skill_upgrade_gold: ['general'],
  asset_moirai_street_bronze: ['general'],
  asset_moirai_power_silver: ['general'],
  asset_moirai_street_silver: ['general'],
  asset_moirai_power_gold: ['general'],
  asset_moirai_street_gold: ['general'],
  asset_moirai_power_rainbow: ['general'],
  asset_moirai_street_rainbow: ['general'],
  asset_chaos_street_bronze: ['general'],
  asset_chaos_power_silver: ['general'],
  asset_chaos_street_silver: ['general'],
  asset_chaos_power_gold: ['general'],
  asset_chaos_street_gold: ['general'],
  asset_chaos_power_rainbow: ['general'],
  asset_chaos_street_rainbow: ['general'],
  asset_psyche_power_silver: ['general'],
  asset_psyche_shield_silver: ['general'],
  asset_psyche_power_gold: ['general'],
  asset_psyche_shield_gold: ['general'],
  asset_psyche_power_rainbow: ['general'],
  asset_psyche_shield_rainbow: ['general'],
  asset_mini_cost_bronze: ['general'],
  asset_mini_cost_silver: ['general'],
  asset_mini_cost_gold: ['general'],
  asset_mini_power_bronze: ['general'],
  asset_mini_power_silver: ['general'],
  asset_mini_power_gold: ['general'],
  asset_risk_reward_bronze: ['general'],
  asset_risk_reward_silver: ['general'],
  asset_risk_reward_gold: ['general'],
  asset_god_mana_discount: ['general'],
  asset_god_texas_skill_plus: ['general'],
  asset_god_mini_mastery: ['general'],
...
function normalizeEncounterActiveEntry(value, rawCharKey = '') {
...
function shouldReplaceEncounterActive(current, next) {
...
function putEncounterActive(target, charKey, entry) {
  if (!target.active) target.active = {};
  if (shouldReplaceEncounterActive(target.active[charKey], entry)) target.active[charKey] = entry;
}
...
function normalizeCharacterEncounterState(value) {
  ...
  if (isPlainObject(source.active)) {
    Object.entries(source.active).forEach(([rawKey, rawEntry]) => {
      const normalized = normalizeEncounterActiveEntry(rawEntry, rawKey);
      if (normalized) putEncounterActive(compact, normalized.charKey, normalized.entry);
    });
  }

  if (isPlainObject(source.met)) {
  ...
  if (isPlainObject(source.signaled)) {
