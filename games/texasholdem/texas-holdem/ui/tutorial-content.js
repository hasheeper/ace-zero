        ...
        sections:[
          ...
          },
          {
            ...
            items:[
              ...
              { label: '技能等级', copy: '通用技能按 I / II / III / IV 四个等级成长。等级越高，通常消耗、威力、冷却或特殊效果越接近完整形态。' }
            ]
          },
          {
            kind: 'keypoints',
            ...
            items:[
              { label: '小愿望', copy: '低费补运技，用于频繁修正局势。' },
              { label: '大愿望', copy: '主力强运技，提供更高强度的 fortune。' },
              { label: '神谕', copy: '高阶天命技，用于关键街强行锁定命运。' }
            ]
          }
        ]
      },
      ...
      curseBasicsPanel: {
        ...
        sections:[
          ...
          },
          {
            ...
            items:[
              { label: '咒蚀', copy: '低费骚扰技，用于频繁施加小额 curse。' },
              { label: '灾乱', copy: '主力厄运技，用于制造中等强度的持续压迫。' },
              { label: '灾厄', copy: '高阶厄运技，用于把目标强行拖入最差分支。' }
            ]
          }
        ]
      },
        ...
        sections:[
          ...
          },
          {
            kind: 'keypoints',
	            ...
	            items:[
	              { label: '解析', copy: '偏信息读取，主要用来判断对手牌力、意图和风险来源。' },
	              { label: '预兆', copy: '偏防守，提前感知厄运落点，并用 Psyche 值抵消打向守护目标的厄运。' },
	              { label: '折射', copy: '偏转化，需要指定厄运来源和打击方向；命中后才会把部分厄运转成好运。' }
	            ]
	          },
          {
            kind: 'keypoints',
            title: '关于专属技能',
            items:[
              { label: '角色专属技能', copy: '部分角色拥有自己的专属技能，例如 VV 的“泡沫清算”。这类技能通常只会在后面的实战中出现。' }
            ]
          }
        ]
      },
          ...
          },
          {
            kind: 'keypoints',
	            ...
	            items:[
	              ...
	              { label: '定神恢复', copy: '使用定神可以恢复自己的状态，减少心理战造成的信息偏差。' }
	            ]
	          }
        ]
      },
