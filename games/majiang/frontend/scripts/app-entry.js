(function(global) {
  ...
  const scriptPaths = [
    ...
    '../../engine/ai/support/discard-shape.js',
    '../../engine/ai/support/discard-candidates.js',
    '../../engine/ai/support/discard-ranking.js',
    '../../engine/ai/support/hard-discard-review.js',
    '../../engine/ai/support/hard-candidate-diagnostics.js',
    '../../engine/ai/difficulty/easy-policy.js',
    '../../engine/ai/difficulty/normal-policy.js',
    '../../engine/ai/difficulty/hard-policy.js',
    '../../engine/ai/difficulty/hard-variants.js',
    '../../engine/ai/evaluators/riichi-evaluator.js',
    '../../engine/ai/evaluators/defense-evaluator.js',
    '../../engine/ai/evaluators/call-evaluator.js',
    '../../engine/ai/evaluators/kan-evaluator.js',
    '../../engine/ai/discard-evaluator.js',
    '../../engine/ai/base-ai.js',
    './runtime/browser-core-adapter.js',
    '../../shared/runtime/luck/constants.js',
    '../../shared/runtime/luck/schemas.js',
    '../../shared/runtime/luck/rng.js',
    '../../shared/runtime/luck/tile-counts.js',
    '../../shared/runtime/luck/candidate-draw.js',
    '../../shared/runtime/luck/objective-intent.js',
    '../../shared/runtime/luck/wind-adjustment.js',
    '../../shared/runtime/luck/force-rank.js',
    '../../shared/runtime/luck/force-resolution.js',
    '../../shared/runtime/luck/weight-model.js',
    '../../shared/runtime/luck/weighted-sampler.js',
    '../../shared/runtime/luck/luck-audit.js',
    '../../shared/runtime/luck/mana-ledger.js',
    '../../shared/runtime/luck/debug-format.js',
    '../../shared/runtime/luck/index.js',
    '../../engine/base/luck-commit-route-evaluator.js',
    '../../engine/base/luck-intent-evaluator.js',
    '../../engine/base/luck-draw-policy.js',
    ...
    './runtime/bridge/modules/action-normalizer.js',
    './runtime/bridge/modules/runtime-factory.js',
    './runtime/bridge/modules/frontend-effects.js',
